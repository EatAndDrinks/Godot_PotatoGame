...
func execute_attack() -> void:
	...
	tween.tween_property(weapon.sprite , "position" , weapon.atk_start_pos , weapon.data.stats.attack_duration)
...
func create_projectile() -> void:
	var instance : Projectile = weapon.data.stats.projectile_scene.instantiate()
